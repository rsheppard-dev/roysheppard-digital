        ...
        <>
            ...
            <main>
                <section className="container">
                    ...
                    <p className={styles.statement}>I design websites that are tailor made with your business in mind. All my websites are included with the following as standard…</p>

                    <ul>
                        <li className={styles.bulletLightning}>
                            <h3>UI/UX web design</h3>
                            <p>Understanding user experience and user interface design are important concepts when designing any website but especially when working with business websites where customer interaction and engagement are critical.</p>
                        </li>
                        <li className={styles.bulletLightning}>
                            <h3>Responsive web design</h3>
                            <p>My websites are made to respond to whatever device your users choose to use, whether that’s a mobile, tablet, laptop or a widescreen monitor.</p>
                        </li>
                        <li className={styles.bulletLightning}>
                            <h3>Accessibility</h3>
                    ...
                    <h2 className="heading">My <span className="underline">web design</span> process</h2>
                    ...
                    <div className={styles.grid}>
                        <div className={styles.cardProcess}>
                            ...
                            />
                            <p>A basic wireframe is drawn up to begin with, to determine what the basic structure of your website will be.</p>
                        </div>
                        ...
                        <div className={styles.cardProcess}>
                            ...
                            />
                            <p>Once you have signed off on the design mockup, I will begin coding your site and integrating any features you have requested.</p>
                        </div>
                        ...
                        <div className={styles.cardProcess}>
                            ...
                            />
                            <p>Once your website is complete it is reviewed and tested to ensure it operates correctly on different browsers and operating systems. As well as ensuring it is responsive on all devices.</p>
                        </div>
                        ...
                        <div className={styles.cardProcess}>
                            ...
                            />
                            <p>Once everything has been checked and you are satisfied, your site is deployed and handed over to you. Time to reap the benefits of having a lead generating website.</p>
                        </div>
                    </div>
                </section>
